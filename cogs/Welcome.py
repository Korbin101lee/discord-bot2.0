...
class Welcome(commands.Cog):
    ...
    async def verify(self, ctx, member: discord.Member):
        await member.remove_roles(member.guild.get_role(1054532224298528880))
        await member.add_roles(member.guild.get_role(1054532296922910812))
